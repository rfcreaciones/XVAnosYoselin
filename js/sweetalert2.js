...
Swal.fire({
	...
	//text: '',
	html:'<p class="textos-alert-inicio">Marlen Martinez Juarez <br> y<br> Alexis Rojas Flores</p><br><p class="textos-alert-inicio-T3">Tenemos el honor de invitar a usted y a su apreciable familia a los xv años de nuestra hija:</p><br><p class="textos-alert-inicio-T2">Yoselin</p></div>',
	//icon:'success'
